...
export const countries: Country[] = [
  ...
  { code: "GY", name: "Guyana", flag: "🇬🇾", dialCode: "+595" },
  ...
  { code: "KZ", name: "Kazakhstan", flag: "🇰🇿", dialCode: "+77" },
  {
    code: "LA",
  ...
  { code: "PN", name: "Pitcairn", flag: "🇵🇳", dialCode: "+872" },
...
// African countries for regional filtering
export const africanCountries = countries.filter(
  (country) => country.regions && country.regions.length > 0,
);

// Popular countries in Southern/Eastern Africa (for Alliance Procurement)
export const popularCountries = countries.filter((country) =>
  ["ZA", "ZM", "ZW", "BW", "MZ", "NA", "MW", "TZ", "KE", "UG", "RW"].includes(
    country.code,
  ),
);
...
export const getCountriesByRegion = (region: string): Country[] => {
  return countries.filter(
    (country) =>
      country.regions &&
      country.regions.some((r) =>
        r.toLowerCase().includes(region.toLowerCase()),
      ),
  );
};

// Auto-detect country based on common patterns (for future geolocation)
export const detectCountryFromTimezone = (): Country | null => {
  try {
    const timezone = Intl.DateTimeFormat().resolvedOptions().timeZone;

    // Basic timezone to country mapping for African countries
