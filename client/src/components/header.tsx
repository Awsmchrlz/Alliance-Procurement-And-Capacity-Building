    ...
    <div className="relative h-12 sm:h-16 w-full overflow-hidden">
      ...
      <div className="absolute left-0 top-0 h-full w-full bg-white flex items-center justify-start pl-4 sm:pl-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-1 sm:space-y-0 space-x-0 sm:space-x-8">
          <span className="text-sm sm:text-lg font-light text-gray-800 whitespace-nowrap">
            FOLLOW US
          </span>
          <div className="flex items-center space-x-1 sm:space-x-2">
            <a
              href="https://www.facebook.com/share/17UjL5Viye/?mibextid=wwXIfr"
              target="_blank"
              rel="noopener noreferrer"
              className="w-3 h-3 sm:w-7 sm:h-7 bg-white border border-black sm:border-2 rounded-full flex items-center justify-center hover:bg-gray-100 transition-colors duration-200"
            >
