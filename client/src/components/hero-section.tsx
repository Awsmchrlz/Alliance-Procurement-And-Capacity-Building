      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-1">
            <div className="relative w-full h-48 sm:h-64 lg:h-80 xl:h-96 flex flex-row items-center justify-center gap-3 sm:gap-5">
              <img
                ...
                className="w-[58%] h-full object-contain drop-shadow-sm hover:scale-105 transition-transform duration-300"
                onError={(e) => {
                  // Fallback styling if image fails to load
                  e.currentTarget.className = "w-[58%] h-full bg-white/10 rounded-lg flex items-center justify-center";
                  e.currentTarget.innerHTML = '<span class="text-[#87CEEB] text-2xl font-bold">APCB</span>';
                }}
              />
              {/* Divider */}
              <div className="w-px h-16 sm:h-24 bg-white/30 flex-shrink-0" />
              <img
