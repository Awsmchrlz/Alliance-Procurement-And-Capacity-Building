...
export function SponsorshipDialog({
  ...
  const selectedLevel = SPONSORSHIP_LEVELS.find(
    (level) => level.id === formData.sponsorshipLevel,
  );
  ...
  const validateStep = (step: number) => {
    if (step === 1) {
      ...
      if (!formData.contactPerson.trim())
        return { isValid: false, message: "Contact person is required" };
    ...
    if (step === 2) {
      if (!formData.sponsorshipLevel)
        return { isValid: false, message: "Please select a sponsorship level" };
    }
      ...
      if (
        ...
        try {
          ...
          toast({
            ...
            description:
              "Registration will continue. You can upload payment evidence later.",
            variant: "default",
          });
        }
      }
      ...
      const sponsorshipData = {
        ...
        amount:
          formData.paymentCurrency === "ZMW"
            ? selectedLevel?.priceZMW || 0
            : selectedLevel?.priceUSD || 0,
  ...
  const renderSuccessScreen = () => (
    <div className="flex flex-col items-center justify-center p-6 text-center min-h-[400px]">
      ...
      <p className="text-gray-600 mb-8 max-w-md leading-relaxed">
        ...
        <span className="font-semibold text-[#1C356B]">{event.title}</span>. Our
        team will review your application and contact you within 2 business
        days.
      </p>
      <Button
        onClick={handleClose}
      ...
      {[1, 2, 3].map((step) => (
        <div
          ...
          className={`w-2 h-2 rounded-full transition-colors duration-200 ${
            step <= currentStep ? "bg-[#1C356B]" : "bg-gray-300"
          }`}
        />
      ))}
    </div>
    ...
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-gray-600">
          Select the package that best fits your marketing goals
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        {SPONSORSHIP_LEVELS.map((level) => (
          <div
            ...
            className={`relative p-4 sm:p-6 border-2 rounded-xl cursor-pointer transition-all duration-300 touch-manipulation transform hover:scale-[1.02] active:scale-[0.98] ${
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                <div
                  className={`p-2 rounded-lg bg-gradient-to-r ${level.color} text-white`}
                >
                  {level.icon}
                </div>
                <div>
      ...
      {selectedLevel && (
        <div className="mt-6 space-y-4">
          <div className="p-4 bg-gradient-to-r from-[#87CEEB]/10 to-blue-50 border border-[#87CEEB]/20 rounded-lg">
            <h4 className="font-semibold text-[#1C356B] mb-2">
          ...
          <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg">
            ...
            <p className="text-sm text-green-700">
              You've selected the <strong>{selectedLevel.name}</strong> package
              for{" "}
              <strong>
                {formData.paymentCurrency === "ZMW"
              ...
              . Click "Submit Application" to send your sponsorship request to
              our team.
            </p>
          </div>
        </div>
  ...
  const renderStep3 = () => (
    <div className="space-y-4">
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-gray-600">
          Choose your payment method and complete your sponsorship
        </p>
      </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-[#87CEEB]/20 shadow-sm">
              <div className="text-center mb-3">
                <div className="text-sm text-gray-500 mb-1">
                  Call (Global) Account Dollar (USD)
                </div>
                <div className="flex items-center justify-center bg-[#87CEEB]/8 p-2 rounded">
                  <span className="text-sm font-mono font-bold text-[#1C356B]">
                    63136717006
                  </span>
                </div>
              </div>
              <div className="space-y-2 text-xs">
                ...
                <div>
                  <span className="font-medium">Branch:</span> Makeni Junction
                </div>
                <div>
                  <span className="font-medium">Swift:</span> FIRNZMLX
                </div>
                <div>
                  <span className="font-medium">Sort Code:</span> 260016
                </div>
                <div>
                  <span className="font-medium">Name:</span> Alliance
                  Procurement and Capacity Building Foundation
                </div>
              </div>
            </div>
      ...
      {formData.paymentMethod === "cash" && (
        <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg">
          ...
          <p className="text-sm text-green-700">
            You can pay in cash at the event registration desk. Please bring the
            exact amount or be prepared for change.
          </p>
        </div>
      )}
      ...
      {(formData.paymentMethod === "mobile" ||
        ...
        <div className="space-y-3">
          ...
          >
            ...
            />
            <label
              htmlFor="sponsorshipEvidenceUpload"
          ...
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-xl">
            <div className="flex items-start space-x-2">
              ...
              <div className="text-xs text-blue-700">
                <strong>Important:</strong> Please upload your payment receipt
                or screenshot after making the payment. This helps us verify and
                process your sponsorship application quickly. Accepted formats:
                PNG, JPG, PDF.
              </div>
            </div>
          </div>
      ...
      <DialogContent className="w-[95vw] sm:max-w-4xl h-[95vh] sm:max-h-[90vh] bg-white border-0 shadow-2xl rounded-lg sm:rounded-xl flex flex-col p-0 overflow-hidden">
        {success ? (
          ...
          <div className="flex flex-col h-full">
            ...
            <div
              ref={scrollRef}
              className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 sm:py-6 pb-24 min-h-0 overscroll-contain"
